...
changes the constraint for a new library release, then the change
should be approved if it passes the tests. See the README.txt in
openstack/releases for more details of the release process.
