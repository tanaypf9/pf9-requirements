...
# Use lowest bound for OSC, newer versions aggressive dependencies
# making it hard to find a dependency set that works for grenade and dsvm-tempest
overrides['python-openstackclient'] = 'python-openstackclient~=0.3.0'
