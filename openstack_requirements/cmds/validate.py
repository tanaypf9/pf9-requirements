...
def main():
    ...
    # FIXME(dhellmann): These items were not in the constraints list
    # but should not be blacklisted. We don't know yet what versions
    # they should have, so just ignore them for a little while until
