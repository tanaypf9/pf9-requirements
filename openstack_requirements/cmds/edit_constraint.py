...
def main(argv=None, stdout=None):
    parser = optparse.OptionParser(
        ...
        epilog=textwrap.dedent("""\
            Replaces any entries to "name" in the constraints file with
            replacement. If name is not present, it is added to the end of the
            file. If replacement is missing or empty, remove name from the
            file.
            """))
