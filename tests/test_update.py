...
class UpdateTest(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.bad_proj_file = os.path.join(self.bad_project_dir, "requirements.txt")
        ...
        self.bad_setup_cfg_file = os.path.join(self.bad_project_dir, "setup.cfg")
        ...
        shutil.copy("tests/files/project-with-bad-dependency.txt", self.bad_proj_file)
        ...
        returncode = subprocess.call([sys.executable, "update.py", "project_with_oslo"])
        self.assertEqual(returncode, 0)
    ...
    def test_requirment_not_in_global(self):
        returncode = subprocess.call([sys.executable, "update.py", "bad_project"])
